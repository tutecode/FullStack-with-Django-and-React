...
class ContactCreateView(APIView):
    ...
    def post(self, request, format=None):
        data = self.request.data  # alway pass data (data from formData)
        ...
        try:
            send_mail(
                ...
                + '\nPhone: ' + phone
                + '\n\nBudget: ' + budget,
                'mail@boomslag.com',  # send this email from Django to us
                ['mail@boomslag.com'],  # recipient list
                fail_silently=False
            )

            # Save data from above into Contact model
